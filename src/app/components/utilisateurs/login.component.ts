...
export class LoginComponent {
  ...
  constructor(private compteservice:CompteService, private globals:Globals, private router:Router) {
  }
  onSubmit(form:NgForm) {
    ...
    this.compteservice.Login(form.value.user, form.value.password).subscribe(data => {
      ...
      if (data.success) {
        ...
        this.globals.setNom(data.username);
        console.log(this.globals.nom);
